...
public class FileBackedTasksManager extends InMemoryTaskManager {
    ...
    public static void main(String[] args) {
        ...
        FileBackedTasksManager manager = new FileBackedTasksManager(Paths.get("resources/test.csv"));
        ...
        /*
        FileBackedTasksManager manager = loadFromFile(Paths.get("resources/test.csv"));
