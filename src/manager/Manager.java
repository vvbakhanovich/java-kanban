...
public class Manager {
     ...
     * добавление эпика с данным идентификатором в epicList.
    ...
    /**
     * Добавление подзадачи в мапу subtaskList. В начале генерируется уникальный идентификатор, затем происходит
     * добавление эпика с данным идентификатором в subtaskList. Так как подзадача напрямую связана со своим эпиком,
     * необходимо добавить ее идентификатор в список подзадач ее эпика. После чего требуется произвести обновление
     * статуса эпика в соотвествии со статусом новой подзадачи.
